...
public class OnClazzParseCondition extends SpringBootCondition implements ConfigurationCondition {

    @Override
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        Map attribute = metadata.getAnnotationAttributes(ParseConditionalOnClazz.class.getName()) ;
